...
Add a [Snapped To Version Group](/config/version-groups/snapped-to) which allows some of the packages in your monorepo to "follow" other packages in terms of which versions they should use.
