...
export const siteConfig = {
  ...
  softwareDescription:
    "Command-line tool for managing dependency versions in JavaScript monorepos. Used by AWS, Cloudflare, DataDog, Electron, Microsoft, Vercel, and others.",
