...
Specifier types can be used to target and filter [Version Groups](/syncpack/guide/version-groups), to apply specific rules to dependencies based on their version format.
