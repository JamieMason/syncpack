...
- [MatchesSemverGroup](STATUS_MATCHES_SEMVER_GROUP)
- [IsLocalAndValid](STATUS_IS_LOCAL_AND_VALID)
- [IsIgnored](STATUS_IS_IGNORED)

### Fixable

- [SemverRangeMismatch](STATUS_SEMVER_RANGE_MISMATCH)
- [DiffersToNpmRegistry](STATUS_DIFFERS_TO_NPM_REGISTRY)
