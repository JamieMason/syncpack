---
title: format
description: Format and sort package.json files consistently across your monorepo
---
...
import ReporterOption from "@partials/option/reporter-format.mdx";
...
<SourceModeOption command="format" />
