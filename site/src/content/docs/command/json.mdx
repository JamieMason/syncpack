...
Each instance printed by `syncpack json` has the type [`JsonOutput`](https://github.com/search?q=repo%3AJamieMason%2Fsyncpack%20%2FJsonOutput%2F%20path%3Anpm%2Fsyncpack.ts&type=code)
