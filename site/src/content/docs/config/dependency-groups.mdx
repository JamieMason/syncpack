...
description: Group related dependencies together to treat them as one for version management
---
...
With the above config: "@aws-sdk/core", "@aws-sdk/middleware-logger" etc will be treated as if they were one dependency, so any differences in their versions will be caught in the usual way.
