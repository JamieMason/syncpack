...
Add a <Link to="/config/version-groups/snapped-to">Snapped To Version Group</Link> which allows some of the packages in your monorepo to "follow" other packages in terms of which versions they should use.
