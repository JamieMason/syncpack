...
This can also occur if the name of the package is not supported. A common case of this is <Link to='https://pnpm.io/package_json#pnpmoverrides'>pnpm overrides</Link>.
