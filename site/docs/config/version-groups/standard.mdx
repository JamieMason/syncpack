...
To set this as your standard policy, create a version group which applies to every dependency as the
last item in your `versionGroups` array. You can also just set this for some of the packages if you
need to.
