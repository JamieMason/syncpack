...
/// package.json files
pub fn get_file_paths<T: DiskIo>(all_patterns: &[String], disk: &Disk<T>) -> Vec<PathBuf> {
...
fn walk_matching<T: DiskIo>(disk: &Disk<T>, include_set: &GlobSet, exclude_set: &GlobSet) -> Vec<PathBuf> {
