...
pub fn get_source_patterns<T: DiskIo>(config: &Config, disk: &Disk<T>) -> Vec<String> {
...
fn get_npm_and_yarn_patterns<T: DiskIo>(disk: &Disk<T>) -> Option<Vec<String>> {
...
fn get_pnpm_patterns<T: DiskIo>(disk: &Disk<T>) -> Option<Vec<String>> {
  disk
    .pnpm_workspace
    .as_ref()?
    .contents
...
fn get_lerna_patterns<T: DiskIo>(disk: &Disk<T>) -> Option<Vec<String>> {
  disk
    .lerna_json
    .as_ref()?
    .contents
