...
export function getInstances(
  ...
  return pipe(
    ...
    Effect.catchTags({
      DeprecatedTypesError: flow(
        errorHandlers.DeprecatedTypesError,
        exitOnError,
      ),
      InvalidCustomTypeError: flow(
        errorHandlers.InvalidCustomTypeError,
        exitOnError,
      ),
      RenamedWorkspaceTypeError: flow(
        errorHandlers.RenamedWorkspaceTypeError,
        exitOnError,
      ),
      SemverGroupConfigError: flow(
        errorHandlers.SemverGroupConfigError,
        exitOnError,
      ),
      VersionGroupConfigError: flow(
        errorHandlers.VersionGroupConfigError,
        exitOnError,
      ),
    }),
  );

  function getSortedAndFiltered<T extends SemverGroup.Any | VersionGroup.Any>(
    groups: T[],
  ) {
