          ...
          [
            {
              path: 'packages/a/package.json',
              before: mockPackage('a', {
                otherProps: { customDeps: { yarn: 'link:vendor/yarn-3.5.2' } },
              }),
              after: mockPackage('a', {
                otherProps: { customDeps: { yarn: 'link:vendor/yarn-3.5.2' } },
              }),
        ...
        (type: string) => () =>
          createScenario(
            [
              ...
              {
                path: 'packages/b/package.json',
                before: mockPackage('b', { [type]: ['yarn@link:vendor/yarn-3.5.2'] }),
                after: mockPackage('b', { [type]: ['yarn@link:vendor/yarn-3.5.2'] }),
              },
            ],
            {
              semverGroups: [
